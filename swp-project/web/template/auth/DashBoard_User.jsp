...
<html lang="en">
    ...
    <head>
        ...
        <!-- endinject -->
        <link rel="shortcut icon" href="assets/assets_template/images/logo-mini-reverse.svg" />
    </head>
    <body>

        <div class="container-scroller">

            <jsp:include page="../SideBar/Sidebar_user.jsp"/>
                                                                                        ...
                                                                                        <c:forEach items="${requestScope.list}" var="temp">
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <div class="d-flex ">
                                                                                                        <a href="#">
                                                                                                            <img src="${temp.getAvatar_link()}" alt="">
                                                                                                        </a>
                                                                                                        <!--<img src="../Access/images/faces/face1.jpg" alt="">-->
                                                                                                        <div>
                                                                                                            <a href="#">
                                                                                                                <h6>${temp.getFull_name()}</h6>
                                                                                                            </a>
                                                                                                            <a href="#">
                                                                                                                <p>${temp.getClass_user()}</p>
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </td>
                                                                                                <td><c:if test="${temp.getIs_live() == 1}">
                                                                                                        <div class="badge badge-opacity-success">Online</div>
                                                                                                    </c:if>
                                                                                                    <c:if test="${temp.getIs_live() != 1}">
