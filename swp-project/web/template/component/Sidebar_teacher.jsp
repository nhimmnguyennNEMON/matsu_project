    ...
    <body>
        ...
        <div class="container-scroller">
                        ...
                        <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                                <div class="dropdown-header text-center">
                                    <img style=" border-radius: 50%; width: 50px; height: 50px; object-fit: cover;" class="hinhanh" src="<%=avatar%>" alt="Profile image">
                                    <p class="mb-1 mt-3 font-weight-semibold"><%=name%></p>
                                    <p class="fw-light text-muted mb-0"><%=email%></p>
                                </div>
                                <a class="dropdown-item" href="/swp-project/auth?go=over-view" ><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> My Profile <span class="badge badge-pill badge-danger"></span></a>
                                <a class="dropdown-item" href="/swp-project/auth?go=change-password"><i  class="dropdown-item-icon mdi mdi mdi-key-minus text-primary me-2"></i> Change Password</a>
                                <a class="dropdown-item" href="/swp-project/auth?go=logout"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="container-fluid page-body-wrapper">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="/swp-project/student/issue?go=list">Issue List</a></li>
                ...
                <script src="../ssets/assets_template/js/Chart.roundedBarCharts.js"></script>
                </body>
