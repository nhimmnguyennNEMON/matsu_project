                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" id="form-add" onsubmit="return false" action="evaluation_criteria" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="iteration_id" name="iteration_id">
                                                    <option value="">--- Choose Iteration ---</option>
                                                     <c:forEach items="${requestScope.listI}" var="temp">
                                                    <option value="${temp.getIteration_id().getId()}">${temp.getIteration_id().getIteration_name()}- ${temp.getIteration_id().getSubject_code()}</option>
                                                    </c:forEach>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="criteria_order" name="criteria_order" placeholder="Criteria Order">
                                                <span class="form-message"></span>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="row text-center align-items-center" >
                                                    ...
                                                    <div class="col-md-3">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" style="margin-right: 20px" name="team_evaluation" id="optionsRadios1" value="true">
                                                            True
                                                        </label>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" style="margin-right: 20px" name="team_evaluation" id="optionsRadios2" value="false" >
                                                            False
                                                        </label>
                                                    </div>
                                                    <span class="form-message"></span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="max_loc" name="max_loc" placeholder="Max Loc">
                                                <span class="form-message"></span>
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                    <label class="col-md-2" for="status">Status<code>(*)</code></label>
                                                    <div class="col-md-2">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" style="margin-right: 20px" name="status" id="optionsRadios1" value="1">
                                                            Active
                                                        </label>
                                                    </div>
                                                    <div class="col-md-2">
