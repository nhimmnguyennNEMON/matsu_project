...
<html lang="en">
    ...
    <body>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <c:if test="${ temp.isStatus()==false}">
                                                                <td style="text-align: center;">
                                                                    <label class="switch">
                                                                        <input type="checkbox" onchange="active(${temp.getCriteria_id()})">
                                                            ...
                                                            <c:if test="${ temp.isStatus()==true}">
                                                                <td style="text-align: center;">
                                                                    <label class="switch">
                                                                        <input type="checkbox" checked onchange="inactive(${temp.getCriteria_id()})">
                                                                        <span class="slider round"></span>
                                                                    </label>
                                                                </td>
                                                            </c:if>
                                                            <!--Detail-->
                                                            <td style="text-align: center;">
                                                                <a href="evaluation_criteria?go=detail&id=${temp.getCriteria_id()}" type="button" class="btn btn-icon" type="button" id="btn-add-setting">
        ...
        <script>
                                                            function callAdd() {
                                                                window.location.href = "/swp-project/manager/evaluation_criteria?go=add"
                                                            }
                                                            ...
                                                            function active(id)
                                                            {
                                                                swal({
                                                                    title: "Are you sure?",
                                                                    text: "You want update action ACTIVE Criteria (ID "+id+")!",
                                                                    icon: "warning",
                                                                    buttons: true,
                                                                    dangerMode: true,
                                                                })
                                                                        .then((willDelete) => {
                                                                            if (willDelete) {
                                                                                ...
                                                                                setTimeout(function () {
                                                                                    window.location.href = "/swp-project/manager/evaluation_criteria?go=active&id=" + id;
                                                                                }, 3000)
                                                                            } else {
                                                                                window.location.href = "/swp-project/manager/evaluation_criteria";
                                                                            }
                                                            ...
                                                            function inactive(id)
                                                            {
                                                                swal({
                                                                    title: "Are you sure?",
                                                                    text: "You want update action INACTIVE Criteria(ID "+id+")!",
                                                                    icon: "warning",
                                                                    buttons: true,
                                                                    dangerMode: true,
                                                                })
                                                                        .then((willDelete) => {
                                                                            if (willDelete) {
                                                                                ...
                                                                                setTimeout(function () {
                                                                                    window.location.href = "/swp-project/manager/evaluation_criteria?go=inactive&id=" + id;
                                                                                }, 3000)
                                                                            } else {
                                                                                window.location.href = "/swp-project/manager/evaluation_criteria";
                                                                            }
