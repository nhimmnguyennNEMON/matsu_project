...
<html lang="en">
    ...
    <body>
                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.list}" var="temp">
                                                        <tr>
                                                            ...
                                                            <!--Detail-->
                                                            <td style="text-align: center;">
                                                                <a href="class?go=detail&class_id=${temp.getId()}" type="button" class="btn btn-icon" type="button" id="btn-add-setting">
        ...
        <script>
                                                            function callAdd() {
                                                                window.location.href = "/swp-project/teacher_manager/class?go=add"
                                                            }
