...
<html lang="vi">
    ...
    <body>
        ...
        <div class="container-scroller">
            ...
            <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed d-flex align-items-top flex-row" id="navbar">
                        ...
                        <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                                <div class="dropdown-header text-center">
                                    <img style=" border-radius: 50%; width: 50px; height: 50px; object-fit: cover; justify-content: center; text-align: center;" class="hinhanh" src="<%=avatar%>" alt="Profile image">
            ...
            <div class="container-fluid page-body-wrapper" style="padding-top: 0px">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        ...
                        <li class="nav-item nav-category">Function List</li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                                <i class="menu-icon mdi mdi-layers-outline"></i>
                                <span class="menu-title">System List</span>
                                <i class="menu-arrow"></i> 
                            </a>
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" href="/swp-project/admin/user">User List</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="/swp-project/admin/setting">Setting List</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="/swp-project/admin/subject">Subject List</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="/swp-project/admin/subject-setting">Subject Setting List</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="/swp-project/manager/iteration">Iteration List</a></li>
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="/swp-project/teacher/team">Team List</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="auth">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" href="/swp-project/teacher/milestones">Milestone List</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="">Milestone Detail</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="auth1">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" href="/swp-project/teacher/class-user?go=view">Class User List</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="">Class User Detail</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="">Class User Import/Export</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="auth2">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" href="">Issue List</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="">Issue Details</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="">Issue Sync</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="">Issue Import/Export</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
